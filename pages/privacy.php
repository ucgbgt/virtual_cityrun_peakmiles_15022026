    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="form-card" style="line-height:1.9;">
          <h5 style="color:#fff;font-weight:700;margin-bottom:12px;">Informasi yang Kami Kumpulkan</h5>
          <p style="color:var(--gray-light);">Kami mengumpulkan informasi yang kamu berikan saat mendaftar, termasuk nama, email, nomor telepon, tanggal lahir, alamat, dan ukuran jersey. Kami juga menyimpan data aktivitas lari yang kamu submit selama event berlangsung.</p>
          <h5 style="color:#fff;font-weight:700;margin:24px 0 12px;">Penggunaan Data</h5>
          <p style="color:var(--gray-light);">Data yang dikumpulkan digunakan untuk: mengelola akun peserta, memverifikasi submission lari, mengirimkan race pack, dan menerbitkan e-certificate. Kami tidak menjual data pribadimu kepada pihak ketiga.</p>
