<?php
/**
 * Budapest Vrtl Hlf Mrthn 2026 Setup Script
 * Run this once to set up the database.
 * Delete this file after setup is complete!
 */

define('SETUP_KEY', 'Budapest Vrtl Hlf Mrthn 20262025setup');
...
$user = 'root';
$pass = '';
$dbname = 'Budapest Vrtl Hlf Mrthn 2026';
...
try {
    ...
    $pdo->prepare("UPDATE users SET password_hash=? WHERE email='admin@Budapest Vrtl Hlf Mrthn 2026.id'")->execute([$hash]);

    echo '<!DOCTYPE html><html><head><title>Setup Budapest Vrtl Hlf Mrthn 2026</title>';
    ...
    echo '<h1>🏃 Budapest Vrtl Hlf Mrthn 2026 Setup</h1>';
    ...
    echo '<p style="color:#9ca3af;">Email: <code>admin@Budapest Vrtl Hlf Mrthn 2026.id</code></p>';
    ...
    echo '<a class="btn" href="http://localhost/Budapest Vrtl Hlf Mrthn 2026/">Buka Website</a>';
    echo '<a class="btn" href="http://localhost/Budapest Vrtl Hlf Mrthn 2026/login.php" style="margin-left:12px;background:#1a1a1a;border:1px solid #f97316;color:#f97316;">Login</a>';
    echo '</div>';
